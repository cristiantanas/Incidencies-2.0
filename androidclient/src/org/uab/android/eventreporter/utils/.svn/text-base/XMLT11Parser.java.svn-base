...
public class XMLT11Parser extends DefaultHandler {

	public static final String PREAMBLE = "<?xml version=\"1.0\" encoding=\"utf-8\"?>";
	public static final String REPORT_TAG = "t11";
	public static final String REPORT_SEVERITY = "ETA=\"";
	public static final String DESCRIPTION_TAG = "description";
	public static final String LINE_REFERENCE_TAG = "lineRef";
	...
	public XMLT11Parser() throws SAXException {
	 ...
	 */
	public static String encode(int severity, String description, String lineRef, long time, 
...
//		String d = Base64Coder.encodeLines(description.getBytes());
		...
		// Encode <lineRef> content </lineRef>
		String l = new String(Base64.encodeBase64(lineRef.getBytes()));
		encodeTag(encodedXML, LINE_REFERENCE_TAG, l);
	...
	public void endElement(String uri, String localName, String qName)
		...
		} else if (localName.equalsIgnoreCase(LINE_REFERENCE_TAG)) {
			notification.setLineReference(elementReader.toString());
