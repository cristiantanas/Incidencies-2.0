...
public class RouteContentManager {
	...
	public RouteContentManager() {
		contents.put(0, new RouteHeader(R.drawable.renfe00,
				"Molins de Rei", "Maçanet-Massanes", "R1", R.array.renfe_c1_line));
		contents.put(1, new RouteHeader(R.drawable.renfe01,
				"Aeroport", "Maçanet-Massanes", "R2 Nord", R.array.renfe_c2_nord_line));
		contents.put(2, new RouteHeader(R.drawable.renfe02,
				"St. Vicenç de Calders", "Barcelona Estació de França", "R2 Sud", R.array.renfe_c2_sud_line));
		...
		contents.put(4, new RouteHeader(R.drawable.renfe04,
				"St. Vicenç de Calders", "Manresa", "R4", R.array.renfe_c4_line));
		...
		contents.put(12, new RouteHeader(R.drawable.fgc12,
				"Barcelona Pl. Catalunya", "Universitat Autònoma", "S55", R.array.fgc_s55_line));
		contents.put(13, new RouteHeader(R.drawable.fgc13,
				"Barcelona Pl. Catalunya", "Rubí Estació", "S5", R.array.fgc_s5_line));
		...
		contents.put(22, new RouteHeader(R.drawable.metro22,
				"Zona Universitària", "Trinitat Nova", "L3", R.array.metro_l3_line));
		...
		contents.put(24, new RouteHeader(R.drawable.metro24,
				"Cornellà Centre", "Vall d\'Hebron", "L5", R.array.metro_l5_line));
		...
		contents.put(27, new RouteHeader(R.drawable.metro27,
				"Trinitat Nova", "Can Cuiás", "L11", R.array.metro_l11_line));
	}
