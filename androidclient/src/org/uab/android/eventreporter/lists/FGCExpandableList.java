...
public class FGCExpandableList extends ExpandableListActivity {
	private static final int FGC_ID = 1;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getExpandableListView().setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				int uniqueLineId = FGC_ID * 10 + groupPosition;
				...
				startActivity(new Intent(getApplicationContext(), ReportSendActivity.class)
						...
						.putExtra("service", Utils.FGC_INCIDENTS)
	...
	private List<Map<String,String>> getGroups() {
		String[] groups = getResources().getStringArray(R.array.fgc_lines);
	...
	private List<List<Map<String,String>>> getChildren() {
		String[][] childrens = new String[][] {
				getResources().getStringArray(R.array.fgc_l6_line),
				getResources().getStringArray(R.array.fgc_s1_line),
				getResources().getStringArray(R.array.fgc_s55_line),
				getResources().getStringArray(R.array.fgc_s5_line),
				getResources().getStringArray(R.array.fgc_s2_line),
				getResources().getStringArray(R.array.fgc_l7_line)
		};
